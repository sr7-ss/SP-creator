...
export const SOFT_SELLING_POINTS = [
  ...
  { key: 'ui_experience', nameEn: 'UI/OS Experience', nameZh: 'UI/系统体验' },
  { key: 'design_language', nameEn: 'Design Language', nameZh: '设计语言' },
  { key: 'after_sales', nameEn: 'After-sales Service', nameZh: '售后服务' },
];
